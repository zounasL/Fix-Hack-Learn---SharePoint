...
public class NewsActivity extends AppCompatActivity {
    ...
    private void postRequest(final String accessToken) {
        ...
        String url= this.getString(R.string.tenant) + "/_api/search/query?querytext='(contenttypeId:0x0101009D1CB255DA76424F860D91F20E6C41180065789619A4EFB44992AF42CEEBB13C9A01* OR contenttypeId:0x0101009D1CB255DA76424F860D91F20E6C41180065789619A4EFB44992AF42CEEBB13C9A02*)'&selectproperties='CanvasContent1OWSHTML,Path,Title,Author,Description'";
                ...
                try {
                    ...
                    for (int i=0; i < result.length(); i++) {
                        ...
                        for (int j = 0; j < cells.length(); j++)
                        {
                            ...
                            if(cells.getJSONObject(j).getString("Key").contentEquals("CanvasContent1OWSHTML")) {
                                canvasContent = cells.getJSONObject(j).getString("Value");
                            }
                        ...
                        if(!path.isEmpty()) {
                            ...
                            news.put("path", path);
                            news.put("canvasContent", canvasContent);
